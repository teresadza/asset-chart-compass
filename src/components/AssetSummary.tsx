import { PricePoint, Asset } from "@/lib/mockData";
...
export function AssetSummary({ asset, data }: AssetSummaryProps) {
  ...
  const totalChangePercent = (totalChange / first.price) * 100;
      ...
      <CardContent className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-5">
        <div className="flex-1">
          ...
          <div className="flex items-baseline gap-3 mt-1">
            <span className="text-3xl font-bold">${latest.price.toFixed(2)}</span>
            <span
